...
int ResultCostMatrix::reduceMatrix() {
    int result = 0;
    int min_cost;
...
void ResultCostMatrix::removeVertix(int from, int to) {
    for(int i = 0; i < vertices_amount; i++){
